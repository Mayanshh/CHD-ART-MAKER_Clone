  ...
  return (
    <div ref={container} className="w-full bg-black text-white">
      ...
      <div ref={mainContentRef} className="opacity-0">
        ...
        <h1 id="heroText" className="fixed z-21 top-[-5.8%] left-1/2 -translate-x-1/2 text-[18.8vw] tracking-[15px] mix-blend-difference pointer-events-none text-white">
          CHDARTMAKER
        </h1>
        ...
        <div  id='textRevealParent' className="relative z-20 w-full min-h-screen bg-white">
            <div className='w-[83%] h-fit absolute bottom-[2.25%] transform -translate-y-1/2 left-0 px-8'>
              <SmoothReveal 
                text=" &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Committed to contemporary creation, we support artists, designers, architects, production companies and project owners in the design, fabrication and on-site installation of artworks, architectural installations, design pieces and prototypes."
            ...
            <h3 id='infoText' className="text-[0.99em] leading-[1.45] text-black w-full tracking-tight align-left max-w-[34%] h-fit absolute bottom-[-2.25%] left-0 px-8">
              With twenty-five years of experience (2001–2025), we bring together technical expertise and artistic sensitivity to all creators. Specialised in art, design, architecture, luxury and events, we offer a bespoke approach that connects study, technical design, fabrication and installation in France and worldwide.
            </h3>
        </div> 
        </ div>
        ...
        <div className="relative z-20 w-full min-h-screen bg-white flex flex-col items-start justify-start px-8">
          <h3 id='infoText2' className="text-[0.99em] leading-[1.45] text-black w-full tracking-tight align-left max-w-[34%] h-fit mt-[3.5%]">
            Our artistic engineering approach allows us to support the integration of art in a wide range of contexts – museums, institutions, public spaces and architectural projects – balancing artistic intention, feasibility and site requirements.          
          </h3>
          ...
          <div className='w-full h-[4em] text-black text-[4.4em] -mt-[0.7em] font-[500] tracking-tight whitespace-nowrap flex items-center overflow-visible'>
            <span className='mr-6 '>FROM CONCEPT</span> 
            ...
            <span className="ml-6">TO FABRICATION</span>
          </div>
          ...
          <div className='h-fit w-[10%] absolute bottom-[1.8em] right-[1.8em] text-black'>
              <a href="#" className='text-[1.2em] uppercase relative bottom-0 right-0 transform -translate-y-1/2'>MORE ON CHD <ArrowDownRight className="w-[0.68em] absolute -bottom-[0.3em] -right-4 " /></a> 
          </div>
        </div>
        ...
        <div className='relative z-20 w-full min-h-screen bg-white flex flex-col items-start justify-between'>
          <div className='w-full mt-[1.5em] inline-flex items-center justify-end h-[3.5em] tracking-tighter text-right pr-[1.8em] text-black'>
           ...
           <div className='h-[3em] w-full  flex items-center justify-between px-[1.8em] text-black'>
              <h4 className='uppercase tracking-tight'>conception</h4>
              ...
              <h4 className='uppercase tracking-tight'>realisation</h4>
           </div>
        </div>
        ...
        <div className='relative z-20 w-full h-[80vh] bg-white flex flex-col items-start justify-start'>
            <h1 className='text-black px-8 text-[1.65em] indent-25 uppercase tracking-tight leading-[1.1] mt-[8vh] mb-[5vh]'>
              25 years of projects, <br /> partnerships and trust.
            </h1>
            <MarqueeSection />
        </div>
          ...
          <div id="contact-section" className='absolute inset-0 bg-yellow-500 flex flex-col items-start justify-start h-screen w-full bg-[url(https://www.chdartmaker.com/media/site/9f9f39e7ec-1756982584/rick-owens-moncler-1440x-q90.webp)] bg-center bg-no-repeat bg-cover z-0'>
            ...
            <div className='w-full max-w-full h-[80px] flex items-center justify-between leading-[1.15] pt-[2.2em] px-8'>
              ...
              <div className='w-[30vw] h-full flex items-start justify-start uppercase text-[1.67em] tracking-tighter'>
               <a href="tel:+33(0)9 67 39 88 35">Tel +33(0)9 67 39 88 35</a>
            </div>
        <div className='w-[30vw] h-full  uppercase text-[1.67em] tracking-tighter text-right'> <a href="mailto:contact@chdartmaker.com"> contact@chdartmaker.com</a> </div> 
            </div>
               ...
               />    
                ...
                <div className='w-full pl-3 h-[30%] flex flex-row justify-between items-start text-white'>
                    ...
                    <p className='text-[0.9em] tracking-tighter uppercase relative top-2 transform -translate-y-1/2'>
                      &copy; 2025, CHD ART MAKER,all rights reserved.Legal Notices Credits
                    </p>
                </div>
                <h1 id='footerHeroText' className="absolute bottom-[-25%] left-1/2 -translate-x-1/2 text-[18.8vw] tracking-[15px] pointer-events-none text-white">
                  CHDARTMAKER
                </h1>  
            </div>
          </div>
