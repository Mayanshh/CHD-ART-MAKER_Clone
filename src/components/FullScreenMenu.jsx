    ...
    <div id='expertise-section' className='min-h-[150vh] relative flex items-center justify-start flex-col w-full h-[150vh] bg-black overflow-hidden'>
      ...
      <div className="relative z-20 w-full min-h-[32.5%] text-white pointer-events-none">
        <div className='okomito-bold w-[47%] h-fit absolute top-[2.25em] left-0 px-8'>
          <SmoothReveal 
            text=" &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; CHD ART MAKER is both a manufacture and a technical design studio dedicated to contemporary creation."
      ...
      <div className='relative z-20 min-h-[67.5%] bg-transparent w-full flex flex-col items-start justify-start px-8'>
        {['STUDY', 'MANUFACTURE', 'INSTALL', 'RESTORE'].map((title, i) => (
          <MenuRow 
            key={title}
            index={i + 1}
            ...
            title={title} 
            description={
                i === 0 ? <>DIALOGUE WITH ARTIST / PROJECT OWNER <br /> SITE & CONSTRAINTs ANALYSIS <br /> FEASIBILITY & TECHNICAL SOLUTIONS</> :
                i === 1 ? <>MULTI-MATERIAL FABRICATION <br /> PROTOTYPES, TESTS & ADJUSTMENTS <br /> ASSEMBLIES & QUALITY CONTROL</> :
                i === 2 ? <>SITE CORDINATION <br /> INSTALLATION METHODS & SAFETY <br /> LIFTING,FIXING & COMPLIANCE</> :
                          <>DIAGNOSTICS & PROTOCOLS <br /> WORKSHOP/ON-SITE INTERVENTIONS <br /> PRESERVATIONS & SECOND LIFE</>
            } 
          />
        ))}
      </div>
